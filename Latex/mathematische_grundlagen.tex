...
\item[(ii)] Die Multiplikation $\cdot$ ist assoziativ: Für $a, b,c \in R$ gilt $a\cdot \left(b \cdot c\right) = \left(a \cdot b \right) \cdot c$.%Blöd weil ich Monoid brauche: $\left(R, \cdot\right)$ ist ein Monoid,
