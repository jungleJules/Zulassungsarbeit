...
%\end{equation*}
Die Menge (Quot(R), +) ist eine abelsche Gruppe. Die Assoziativität und Kommutativität können leicht nachgerechnet werden. Das neutrale Element der Addition ist $0 = \frac{0}{1}$, das negative Element der Addition ist $-\left(\frac{r}{u}\right) = \frac{-r}{u}$.\\
