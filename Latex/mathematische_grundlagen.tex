...
\begin{bsp}
Die Abbildung $G \to [G], a \mapsto [a]$, ist eine Bewertung und wird als \textit{natürliche Bewertung} bezeichnet (dabei ist $[0]$ das kleinste Element). %\cite{priesscrampe83}
\end{bsp}
%
%
%
