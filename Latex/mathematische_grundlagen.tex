...
\end{folg}
\beweis{
Nach dem Satz von Hölder \ref{aga} ist $G$ o-isomorph zu einer Untergruppe der additiven Gruppe der reellen Zahlen. Wir wissen wegen Satz \ref{homomorphismus nach R} bereits, dass es eine reelle positive Zahl $r$ gibt, sodass der o-Monomorphismus die Form $\phi\colon G\to \R,g \mapsto rg$ hat. Die Konkatenation des o-Isomorphismus und o-Monomorphismus ergibt wiederum einen o-Monomorphismus. Wir wählen für $0 < g \in G$ ein $r:= \frac{1}{g}$. Dieser Quotient existiert, da $g \neq 0$ ist und $G$ o-isomorph zu einer Untergruppe des Körpers der reellen Zahlen ist und das Inverse zu $g$, nämlich $\frac{1}{g}$ existiert. Da $g$ nach Voraussetzung positiv ist, folgt die Positivität von $r$. Die Abbildung $\Phi \colon G\to \R, g\mapsto rg = \frac{1}{g} \cdot g = 1_\R$ ist nach Satz \ref{homomorphismus nach R} ein o-Monomorphismus. \\
Die Eindeutigkeit des o-Monomorphismus der Form $\Phi \colon G\to \R, g\mapsto 1$ folgt direkt aus der Eindeutigkeit des Quotienten $\frac{1}{g}$, welche wir aufgrund der o-Isomorphie zu einer Untergruppe der reellen Zahlen erhalten.
}
%
%
%
