...
%
%
\subsection{Addition und Multiplikation formaler Laurentreihen}
%
%
...
\end{equation*} 
Die Addition und Mulitplikation formaler Laurentreihen erfolgt analog zur Addition und Multiplikation formaler Potenzreihen.
\begin{defn}
...
Wir fokussieren unsere Betrachtungen auf verallgemeinerte Potenzreihen auf angeordneten abelschen Gruppen. 
...
Im Folgenden betrachten wir allgemeinere Arten von Mengen, nämlich die bereits in dem vorherigen Kapitel \ref{chap2} vorgestellten angeordneten abelschen Gruppen. Wir zeigen, dass 
...
Sei $\Gamma$ eine angeordnete abelsche Gruppe. Wir beschäftigen uns in dieser Arbeit ausschließlich mit der additiv geschriebenen Gruppe $\Gamma$. Die Äquivalenzklassen, die durch die archimedische Gleichheit \ref{archimedischeKlassen} entstehen, bilden eine total geordnete Menge, wir bezeichnen sie mit $\Pi$. Durch jedes positive Element $a \in \Gamma$, respektive seine Äquivalenzklasse $[a]= \pi$ werden zwei konvexe Untergruppen $L_\pi,~ U_\pi$  definiert. \\
